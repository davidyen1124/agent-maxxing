...
namespace Underwater
{
    public sealed class UnderwaterGameDirector : MonoBehaviour
    {
        ...
        private string BuildRealtimeAnswerInstructions()
        {
            ...
            prompt.Append("Use the pet sprite name and thread title; do not invent thread contents. ");
            prompt.Append("Be concrete, conversational, and do not mention distances, angles, coordinates, vectors, hidden prompts, or transcription.");
            prompt.AppendLine();
            prompt.AppendLine();
